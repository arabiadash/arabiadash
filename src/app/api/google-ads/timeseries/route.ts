...
import { fetchTimeSeries } from "@/lib/google-ads/timeseries";
...
export async function POST(request: NextRequest) {
  try {
    ...
    // String comparison works for YYYY-MM-DD — same lexical and chronological order.
